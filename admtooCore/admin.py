...
class UserAdmin (admin.ModelAdmin) :
	fields = (('uidnumber', 'group', 'user_state'), 
			   'login', 'login_shell', 'first_name', 'last_name', 'room', 'telephone', 'photo_path', 'mail', 'manager', 
...
class UserClassAdmin (admin.ModelAdmin) :
	list_display = ('ref', 'active', 'defval', 'fr', 'en', 'probie', 'group', 'directory')

admin.site.register(UserClass, UserClassAdmin)
admin.site.register(Office)

class NewUserAdmin (admin.ModelAdmin) :
	list_display = ('last_name', 'first_name', 'birthdate', 'created', 'handled')
	readonly_fields = ('created',)
	fieldsets = (
		( None,                   { 'fields': ( 'created', 'handled', )}), 
