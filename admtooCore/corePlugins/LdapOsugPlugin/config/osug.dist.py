...
OSUG_LDAP_IPAG_MAILALIAS_OU = 'ou=mailalias'
OSUG_LDAP_IPAG_MAILINGLIST_OU = 'ou=mailinglist'
OSUG_LDAP_IPAG_MAILINGLIST_DOMAIN = 'example.com'
...
OSUG_LDAP_IPAG_RH_GROUP = 'cn=administratif,'+OSUG_LDAP_IPAG_GROUP_OU+','+OSUG_LDAP_IPAG_BASE

OSUG_LDAP_IPAG_EXPIRE_DATE_DELAY = 90
